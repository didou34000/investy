...
function calculateScore(answers: Record<string, string>): number {
  ...
  // Valeurs neutres pour UNK
  scoreMap.drawdown_max["UNK"] = 40;
  scoreMap.horizon_years["UNK"] = 50;
  scoreMap.wealth_share["UNK"] = 45;
  scoreMap.pref_return["UNK"] = 48;
  scoreMap.asset_interest["UNK"] = 40;
  scoreMap.monthly_investment["UNK"] = 40;
  scoreMap.reaction_drop["UNK"] = 40;
  scoreMap.follow_intensity["UNK"] = 50;
  scoreMap.reinvest["UNK"] = 50;
